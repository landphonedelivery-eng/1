...
export default function AdminPage() {
  ...
  const [priceLevels, setPriceLevels] = useState<PriceLevel[]>([
    {
      ...
      sizes: {
        "13×5": {
          marketers: { monthly: 4500, threeMonths: 4200, sixMonths: 4000, yearly: 3800 },
          companies: { monthly: 4000, threeMonths: 3700, sixMonths: 3500, yearly: 3300 },
          individuals: { monthly: 3500, threeMonths: 3200, sixMonths: 3000, yearly: 2800 },
        },
        "12×4": {
          marketers: { monthly: 3800, threeMonths: 3500, sixMonths: 3300, yearly: 3100 },
          companies: { monthly: 3300, threeMonths: 3000, sixMonths: 2800, yearly: 2600 },
          individuals: { monthly: 2800, threeMonths: 2500, sixMonths: 2300, yearly: 2100 },
        },
        "10×4": {
          marketers: { monthly: 3200, threeMonths: 2900, sixMonths: 2700, yearly: 2500 },
          companies: { monthly: 2700, threeMonths: 2400, sixMonths: 2200, yearly: 2000 },
          individuals: { monthly: 2200, threeMonths: 1900, sixMonths: 1700, yearly: 1500 },
        },
        "8×3": {
          marketers: { monthly: 2500, threeMonths: 2200, sixMonths: 2000, yearly: 1800 },
          companies: { monthly: 2000, threeMonths: 1700, sixMonths: 1500, yearly: 1300 },
          individuals: { monthly: 1500, threeMonths: 1200, sixMonths: 1000, yearly: 800 },
        },
        "6×3": {
          marketers: { monthly: 2000, threeMonths: 1700, sixMonths: 1500, yearly: 1300 },
          companies: { monthly: 1500, threeMonths: 1200, sixMonths: 1000, yearly: 800 },
          individuals: { monthly: 1000, threeMonths: 700, sixMonths: 500, yearly: 300 },
        },
        "4×3": {
          marketers: { monthly: 1500, threeMonths: 1200, sixMonths: 1000, yearly: 800 },
          companies: { monthly: 1000, threeMonths: 700, sixMonths: 500, yearly: 300 },
          individuals: { monthly: 800, threeMonths: 500, sixMonths: 300, yearly: 100 },
        },
      },
      cities: {
    ...
    },
    {
      ...
      sizes: {
        "13×5": {
          marketers: { monthly: 3500, threeMonths: 3200, sixMonths: 3000, yearly: 2800 },
          companies: { monthly: 3000, threeMonths: 2700, sixMonths: 2500, yearly: 2300 },
          individuals: { monthly: 2500, threeMonths: 2200, sixMonths: 2000, yearly: 1800 },
        },
        "12×4": {
          marketers: { monthly: 2800, threeMonths: 2500, sixMonths: 2300, yearly: 2100 },
          companies: { monthly: 2300, threeMonths: 2000, sixMonths: 1800, yearly: 1600 },
          individuals: { monthly: 1800, threeMonths: 1500, sixMonths: 1300, yearly: 1100 },
        },
        "10×4": {
          marketers: { monthly: 2200, threeMonths: 1900, sixMonths: 1700, yearly: 1500 },
          companies: { monthly: 1700, threeMonths: 1400, sixMonths: 1200, yearly: 1000 },
          individuals: { monthly: 1200, threeMonths: 900, sixMonths: 700, yearly: 500 },
        },
        "8×3": {
          marketers: { monthly: 1800, threeMonths: 1500, sixMonths: 1300, yearly: 1100 },
          companies: { monthly: 1300, threeMonths: 1000, sixMonths: 800, yearly: 600 },
          individuals: { monthly: 1000, threeMonths: 700, sixMonths: 500, yearly: 300 },
        },
        "6×3": {
          marketers: { monthly: 1500, threeMonths: 1200, sixMonths: 1000, yearly: 800 },
          companies: { monthly: 1000, threeMonths: 700, sixMonths: 500, yearly: 300 },
          individuals: { monthly: 700, threeMonths: 400, sixMonths: 200, yearly: 100 },
        },
        "4×3": {
          marketers: { monthly: 1200, threeMonths: 900, sixMonths: 700, yearly: 500 },
          companies: { monthly: 800, threeMonths: 500, sixMonths: 300, yearly: 100 },
          individuals: { monthly: 500, threeMonths: 200, sixMonths: 100, yearly: 50 },
        },
      },
      cities: {
        طرابلس: { multiplier: 1.2 },
  ...
  const getPrice = (
    ...
    level: "A" | "B" = "A",
    duration: "monthly" | "threeMonths" | "sixMonths" | "yearly" = "monthly",
  ) => {
    const priceLevel = priceLevels.find((p) => p.level === level)
    if (!priceLevel) return 2000

    const sizePrice = priceLevel.sizes[size]?.[customerType]?.[duration] || 2000
    const cityMultiplier = priceLevel.cities[city]?.multiplier || 1.0

    return Math.round(sizePrice * cityMultiplier)
  }

  const updatePrice = (levelId: string, size: string, category: string, duration: string, newPrice: number) => {
    setPriceLevels((prev) =>
      prev.map((level) => {
        if (level.id === levelId) {
          return {
  ...
  const addNewSize = (levelId: string, newSize: string) => {
    const defaultPrices = {
      marketers: { monthly: 1000, threeMonths: 900, sixMonths: 800, yearly: 700 },
      companies: { monthly: 800, threeMonths: 700, sixMonths: 600, yearly: 500 },
      individuals: { monthly: 600, threeMonths: 500, sixMonths: 400, yearly: 300 },
    }
  ...
  const [newSizeInput, setNewSizeInput] = useState<{ levelId: string; size: string } | null>(null)
  const [selectedDuration, setSelectedDuration] = useState<"monthly" | "threeMonths" | "sixMonths" | "yearly">(
    "monthly",
  )
      ...
      >
        <Card className="w-full max-w-md shadow-2xl border-0">
          <CardHeader className="text-center pb-2">
            ...
            <CardTitle className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-yellow-600 dark:from-white dark:to-yellow-400 bg-clip-text text-transparent">
          ...
          <CardContent className="pt-6">
            ...
            <div className="mt-6 text-center text-sm text-gray-500 dark:text-gray-400">
              <p>بيانات تجريبية:</p>
              <p>
                المستخدم: <span className="font-mono">mlk</span>
              </p>
              <p>
                كلمة المرور: <span className="font-mono">12345678</span>
              </p>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">
                    إدارة أسعار اللوحات الإعلانية حسب المستوى وفئة العميل والمدة
                  </p>
                </div>
              ...
              <Card className="border-0 shadow-lg bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20">
                <CardContent className="p-6">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    {[
                      { key: "monthly", label: "شهر واحد", color: "bg-blue-500" },
                      { key: "threeMonths", label: "3 أشهر", color: "bg-green-500" },
                      { key: "sixMonths", label: "6 أشهر", color: "bg-orange-500" },
                      { key: "yearly", label: "سنة كاملة", color: "bg-purple-500" },
                    ].map((duration) => (
                      <Button
                        key={duration.key}
                        ...
                        className={`${
                          selectedDuration === duration.key
                            ? `${duration.color} text-white shadow-lg scale-105`
              ...
              {priceLevels.map((level) => (
                <Card key={level.id} className="border-0 shadow-lg">
                  <CardHeader className="bg-gradient-to-r from-yellow-50 to-amber-50 dark:from-yellow-900/20 dark:to-amber-900/20">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <Button
                          onClick={() => setNewSizeInput({ levelId: level.id, size: "" })}
                          size="sm"
                          className="bg-green-500 hover:bg-green-600 text-white"
                        >
                  ...
                  <CardContent className="p-6">
                    {newSizeInput?.levelId === level.id && (
                      <div className="mb-6 p-4 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
                        <h4 className="font-semibold text-green-800 dark:text-green-300 mb-3">إضافة مقاس جديد</h4>
                        <div className="flex gap-3 items-center">
                          ...
                          <Button
                            onClick={() => {
                              if (newSizeInput.size.trim()) {
                                addNewSize(level.id, newSizeInput.size.trim())
                                setNewSizeInput(null)
                              }
                            }}
                            className="bg-green-500 hover:bg-green-600 text-white"
                          >
                          ...
                          <Button onClick={() => setNewSizeInput(null)} variant="outline">
                            إلغاء
                          </Button>
                        </div>
                      </div>
                        ...
                        <table className="w-full border-collapse">
                          <thead>
                            <tr className="bg-gray-50 dark:bg-gray-800">
                              ...
                              <th className="border border-gray-200 dark:border-gray-700 p-3 text-center font-semibold text-red-600">
                                إجراءات
                              </th>
                            </tr>
                          </thead>
                              ...
                              <tr key={size} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                                ...
                                {Object.entries(prices).map(([category, categoryPrices]) => (
                                  ...
                                  >
                                    ...
                                    editingPrice?.duration === selectedDuration ? (
                                      <div className="flex items-center gap-2">
                                        <Input
                                          type="number"
                                        ...
                                        <Button
                                          size="sm"
                                          onClick={() => {
                                            updatePrice(level.id, size, category, selectedDuration, editingPrice.value)
                                            setEditingPrice(null)
                                          }}
                                      ...
                                      <div
                                        ...
                                        onClick={() =>
                                          setEditingPrice({
                                            ...
                                            value: categoryPrices[selectedDuration],
                                          })
                                        }
                                      >
                                        <span className="font-bold text-gray-900 dark:text-gray-100">
                                          {categoryPrices[selectedDuration].toLocaleString()}
                                        </span>
                                ...
                                <td className="border border-gray-200 dark:border-gray-700 p-3 text-center">
                                  <Button
                                    onClick={() => {
                                      if (confirm(`هل أنت متأكد من حذف مقاس ${size}؟`)) {
                                        setPriceLevels((prev) =>
                                          prev.map((l) => {
                                            if (l.id === level.id) {
                                              const newSizes = { ...l.sizes }
                    ...
                    <div className="mb-8">
                      <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100 mb-4 flex items-center">
                        ...
                        مقارنة الأسعار حسب المدة (مثال: مقاس 13×5 - شركات)
                      </h3>
                      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                        {[
                          { key: "monthly", label: "شهر واحد", color: "bg-blue-500", discount: "0%" },
                          { key: "threeMonths", label: "3 أشهر", color: "bg-green-500", discount: "8%" },
                          { key: "sixMonths", label: "6 أشهر", color: "bg-orange-500", discount: "13%" },
                          { key: "yearly", label: "سنة كاملة", color: "bg-purple-500", discount: "18%" },
                        ].map((duration) => {
                          const examplePrice = level.sizes["13×5"]?.companies?.[duration.key] || 0
                          return (
                            <div
                              key={duration.key}
                              className="bg-white dark:bg-gray-800 rounded-lg p-4 border border-gray-200 dark:border-gray-700"
                            >
                              <div className={`w-full h-2 ${duration.color} rounded-full mb-3`}></div>
                              <h4 className="font-bold text-gray-900 dark:text-gray-100">{duration.label}</h4>
                              <p className="text-2xl font-bold text-gray-900 dark:text-gray-100 mt-2">
                                {examplePrice.toLocaleString()} <span className="text-sm text-gray-500">د.ل</span>
                              </p>
                              <p className="text-sm text-green-600 font-semibold">توفير {duration.discount}</p>
                            </div>
                          )
                        })}
                      </div>
                    ...
                    <table className="w-full border-collapse">
                      <thead>
                        <tr className="bg-blue-50 dark:bg-blue-900/20">
                          <th className="border border-blue-200 dark:border-blue-700 p-3 text-right font-semibold">
                            الفئة
                          </th>
                          <th className="border border-blue-200 dark:border-blue-700 p-3 text-center font-semibold">
                            النوع
                          </th>
                          <th className="border border-blue-200 dark:border-blue-700 p-3 text-center font-semibold">
                            نسبة الخصم
                      ...
                      <tbody>
                        {customerCategories.map((category) => (
                          <tr key={category.id} className="hover:bg-blue-50 dark:hover:bg-blue-900/10">
                            <td className="border border-blue-200 dark:border-blue-700 p-3 font-semibold">
                              {category.name}
                            </td>
                            <td className="border border-blue-200 dark:border-blue-700 p-3 text-center">
                              {category.type}
                            </td>
                            <td className="border border-blue-200 dark:border-blue-700 p-3 text-center">
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">عرض وتعديل وإدارة جميع العقود</p>
                </div>
                <div className="flex gap-3">
                  <Button
                    onClick={() => {
                      ...
                      const link = document.createElement("a")
                      link.href = url
                      link.download = "billboard-contracts.json"
                      link.click()
                    }}
                    variant="outline"
                    className="border-yellow-500 text-yellow-600 hover:bg-yellow-50"
                  ...
                  <Button
                    onClick={() => {
                      ...
                      alert("سيتم إضافة وظيفة إنشاء التقارير هنا")
                    }}
                    variant="outline"
                ...
                {contracts.map((contract) => (
                  <Card key={contract.id} className="border-0 shadow-lg">
                    <CardHeader className="flex items-center justify-between">
                      <div>
                        <CardTitle className="text-xl font-bold">
                          {contract.customerName} - {contract.contractNumber}
                        </CardTitle>
                        <CardDescription className="text-gray-500 dark:text-gray-400">
                          {contract.customerCompany || "عميل فردي"}
                        </CardDescription>
                      </div>
                      <Badge
                        variant={contract.status === "active" ? "default" : "secondary"}
                        className={
                          contract.status === "active" ? "bg-green-500 text-white" : "bg-gray-100 text-gray-700"
                        }
                      >
                        {contract.status}
                      </Badge>
                    ...
                    <CardContent>
                      <div className="space-y-3">
                        <p>
                          <span className="font-semibold">تاريخ البداية:</span> {contract.startDate}
                        </p>
                        <p>
                          <span className="font-semibold">تاريخ النهاية:</span> {contract.endDate}
                        </p>
                        <p>
                          <span className="font-semibold">إجمالي السعر:</span> {contract.totalPrice.toLocaleString()}{" "}
                          د.ل
                        </p>
                        <div className="flex items-center gap-2">
                          <Button
                          ...
                          <Button
                            onClick={() => {
                              ...
                              alert("سيتم إضافة وظيفة تعديل العقد هنا")
                            }}
                            variant="outline"
                            className="border-yellow-500 text-yellow-600 hover:bg-yellow-50"
                          >
              ...
              {showContractPreview && selectedContract && (
                ...
                >
                  <Card className="w-3/4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                    <CardHeader className="flex justify-between items-center">
                      <CardTitle className="text-2xl font-bold">
                        معاينة العقد - {selectedContract.contractNumber}
                      </CardTitle>
                      <Button variant="ghost" size="icon" onClick={() => setShowContractPreview(false)}>
                        <X className="w-5 h-5" />
                      </Button>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <p>
                        <span className="font-semibold">اسم العميل:</span> {selectedContract.customerName}
                      </p>
                      <p>
                        <span className="font-semibold">الشركة:</span> {selectedContract.customerCompany || "لا يوجد"}
                      </p>
                      <p>
                        <span className="font-semibold">تاريخ البداية:</span> {selectedContract.startDate}
                      </p>
                      <p>
                        <span className="font-semibold">تاريخ النهاية:</span> {selectedContract.endDate}
                      </p>
                      <p>
                        <span className="font-semibold">إجمالي السعر:</span>{" "}
                        {selectedContract.totalPrice.toLocaleString()} د.ل
                      </p>
                      <h3 className="text-xl font-bold">اللوحات الإعلانية</h3>
                      <ul className="list-disc list-inside">
                        {selectedContract.billboards.map((billboard) => (
                          <li key={billboard.id}>
                            {billboard.name} - {billboard.size} ({billboard.city}) - {billboard.price.toLocaleString()}{" "}
                            د.ل
                          </li>
                        ))}
                      </ul>
                      <h3 className="text-xl font-bold">الشروط والأحكام</h3>
                      <p className="whitespace-pre-line">{selectedContract.terms || "لا توجد شروط وأحكام"}</p>
                      <p>
                        <span className="font-semibold">ملاحظات:</span> {selectedContract.notes || "لا توجد ملاحظات"}
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">عرض وتعديل وإدارة جميع الفواتير</p>
                </div>
                <div className="flex gap-3">
                  <Button
                    onClick={() => {
                      ...
                      const link = document.createElement("a")
                      link.href = url
                      link.download = "billboard-invoices.json"
                      link.click()
                    }}
                    variant="outline"
                    className="border-yellow-500 text-yellow-600 hover:bg-yellow-50"
                  ...
                  <Card key={invoice.id} className="border-0 shadow-lg">
                    <CardHeader className="flex items-center justify-between">
                      <div>
                        ...
                        <CardDescription className="text-gray-500 dark:text-gray-400">
                          {invoice.customerCompany || "عميل فردي"}
                        </CardDescription>
                      </div>
                      <Badge
                        variant={invoice.status === "paid" ? "default" : "secondary"}
                        className={invoice.status === "paid" ? "bg-green-500 text-white" : "bg-gray-100 text-gray-700"}
                      >
                        {invoice.status}
                      </Badge>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        <p>
                          <span className="font-semibold">تاريخ الإصدار:</span> {invoice.issueDate}
                        </p>
                        <p>
                          <span className="font-semibold">تاريخ الاستحقاق:</span> {invoice.dueDate}
                        </p>
                        <p>
                          <span className="font-semibold">الإجمالي:</span> {invoice.total.toLocaleString()} د.ل
                        </p>
                        <div className="flex items-center gap-2">
                          <Button
                            onClick={() => {
                          ...
                          <Button
                            onClick={() => {
                              ...
                              alert("سيتم إضافة وظيفة تعديل الفاتورة هنا")
                            }}
                            variant="outline"
                            className="border-yellow-500 text-yellow-600 hover:bg-yellow-50"
                          >
                ...
                >
                  <Card className="w-3/4 max-h-[90vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
                    <CardHeader className="flex justify-between items-center">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => setShowInvoicePreview(false)}>
                        <X className="w-5 h-5" />
                      </Button>
                    </CardHeader>
                    <CardContent className="space-y-4">
                      <p>
                        <span className="font-semibold">اسم العميل:</span> {selectedInvoice.customerName}
                      </p>
                      <p>
                        <span className="font-semibold">الشركة:</span> {selectedInvoice.customerCompany || "لا يوجد"}
                      </p>
                      <p>
                        <span className="font-semibold">تاريخ الإصدار:</span> {selectedInvoice.issueDate}
                      </p>
                      <p>
                        <span className="font-semibold">تاريخ الاستحقاق:</span> {selectedInvoice.dueDate}
                      </p>
                      <p>
                        <span className="font-semibold">الإجمالي:</span> {selectedInvoice.total.toLocaleString()} د.ل
                      </p>
                      <h3 className="text-xl font-bold">اللوحات الإعلانية</h3>
                      <ul className="list-disc list-inside">
                        {selectedInvoice.billboards.map((billboard) => (
                          <li key={billboard.id}>
                            {billboard.name} - {billboard.size} ({billboard.city}) - {billboard.price.toLocaleString()}{" "}
                            د.ل
                          </li>
                      ...
                      <p>
                        <span className="font-semibold">المبلغ الفرعي:</span>{" "}
                        {selectedInvoice.subtotal.toLocaleString()} د.ل
                      </p>
                      <p>
                        <span className="font-semibold">الضريبة:</span> {selectedInvoice.tax.toLocaleString()} د.ل
                      </p>
                      <p>
                        <span className="font-semibold">الخصم:</span> {selectedInvoice.discount.toLocaleString()} د.ل
                      </p>
                      <p>
                        <span className="font-semibold">ملاحظات:</span> {selectedInvoice.notes || "لا توجد ملاحظات"}
                      </p>
                    </CardContent>
                  </Card>
                </div>
            ...
            <div className="space-y-8">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400 mt-2">عرض وتعديل وإدارة حسابات المستخدمين</p>
                </div>
                <Button onClick={() => setShowAddUserForm(true)} className="bg-green-500 hover:bg-green-600 text-white">
                ...
                <Card className="border-0 shadow-lg">
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex justify-end gap-2">
                      ...
                      <Button className="bg-green-500 hover:bg-green-600 text-white">حفظ</Button>
                    </div>
                  </CardContent>
                </Card>
              )}
                  ...
                  <Card key={user.id} className="border-0 shadow-lg">
                    <CardHeader className="flex items-center justify-between">
                      ...
                      <Badge
                        ...
                        className={user.role === "admin" ? "bg-blue-500 text-white" : "bg-gray-100 text-gray-700"}
                      >
                        {user.role}
                      </Badge>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        <p>
                          <span className="font-semibold">تاريخ الإنشاء:</span> {user.createdAt}
                        </p>
                        <p>
                          <span className="font-semibold">آخر تسجيل دخول:</span> {user.lastLogin || "لم يسجل الدخول"}
                        </p>
                        <div className="flex items-center gap-2">
                          <Button
                            onClick={() => {
                              // Edit user functionality
                              alert("سيتم إضافة وظيفة تعديل المستخدم هنا")
                            }}
                            variant="outline"
                            className="border-yellow-500 text-yellow-600 hover:bg-yellow-50"
                          >
                          ...
                          <Button
                            onClick={() => {
                              ...
                              alert("سيتم إضافة وظيفة تغيير كلمة المرور هنا")
                            }}
                            variant="outline"
                            className="border-blue-500 text-blue-600 hover:bg-blue-50"
                          >
